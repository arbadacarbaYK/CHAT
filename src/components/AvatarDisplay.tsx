...
export const AvatarDisplay: React.FC<AvatarDisplayProps> = ({ glbUrl, cameraOrbit = '0deg 90deg 6m', fieldOfView = '30deg', headOnly, reactTrigger, mainPage }) => {
  ...
  return (
    <div className={mainPage ? "w-full h-full max-h-[90vh] flex items-center justify-center bg-black/10" : "w-full max-w-md aspect-[3/4] max-h-[70vh] mx-auto flex items-center justify-center bg-black/10"}>
      {ready ? (
        <model-viewer
          className={animClass}
          src={glbUrl}
